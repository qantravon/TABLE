...
/*******************************************************************************
* Function Name: ADC_1_Ext_CP_Clk_Start
********************************************************************************
* Summary:
...
void ADC_1_Ext_CP_Clk_Start(void) 
{
    ...
    ADC_1_Ext_CP_Clk_CLKEN |= ADC_1_Ext_CP_Clk_CLKEN_MASK;
}


/*******************************************************************************
* Function Name: ADC_1_Ext_CP_Clk_Stop
********************************************************************************
* Summary:
...
/*******************************************************************************
* Function Name: ADC_1_Ext_CP_Clk_StopBlock
********************************************************************************
* Summary:
...
{
    if (ADC_1_Ext_CP_Clk_CLKEN & ADC_1_Ext_CP_Clk_CLKEN_MASK)
    {
        ...
        CLK_DIST_AMASK = ADC_1_Ext_CP_Clk_CLKEN_MASK;
        CLK_DIST_DMASK = 0x00u;
#else
        CLK_DIST_DMASK = ADC_1_Ext_CP_Clk_CLKEN_MASK;
        ...
        oldDivider = CY_GET_REG16(ADC_1_Ext_CP_Clk_DIV_PTR);
        ...
        CLK_DIST_LD = 0x00u;
        CY_SET_REG16(ADC_1_Ext_CP_Clk_DIV_PTR, oldDivider);
#endif
    }
}
#endif
...
/*******************************************************************************
* Function Name: ADC_1_Ext_CP_Clk_StandbyPower
********************************************************************************
* Summary:
...
void ADC_1_Ext_CP_Clk_StandbyPower(uint8 state) 
{
    if(state == 0)
    {
        ADC_1_Ext_CP_Clk_CLKSTBY &= ~ADC_1_Ext_CP_Clk_CLKSTBY_MASK;
    }
    else
    {
        ADC_1_Ext_CP_Clk_CLKSTBY |= ADC_1_Ext_CP_Clk_CLKSTBY_MASK;
...
/*******************************************************************************
* Function Name: ADC_1_Ext_CP_Clk_SetDividerRegister
********************************************************************************
* Summary:
...
*
*******************************************************************************/
void ADC_1_Ext_CP_Clk_SetDividerRegister(uint16 clkDivider, uint8 restart) 
{
    uint8 enabled;

    uint8 currSrc = ADC_1_Ext_CP_Clk_GetSourceRegister();
    uint16 oldDivider = ADC_1_Ext_CP_Clk_GetDividerRegister();

    if (clkDivider != oldDivider)
    {
        enabled = ADC_1_Ext_CP_Clk_CLKEN & ADC_1_Ext_CP_Clk_CLKEN_MASK;
        ...
        if (currSrc == CYCLK_SRC_SEL_CLK_SYNC_D && (oldDivider == 0 || clkDivider == 0))
        {
            ...
            if (oldDivider == 0 && clkDivider != 0)
            {
                ...
                CY_SET_REG16(ADC_1_Ext_CP_Clk_DIV_PTR, clkDivider);
                ADC_1_Ext_CP_Clk_MOD_SRC &= ~CYCLK_SSS;
            }
            else
            {
        ...
        else
        {
            ...
            ADC_1_Ext_CP_Clk_CLKEN |= enabled;
        }
    }
}
...
/*******************************************************************************
* Function Name: ADC_1_Ext_CP_Clk_GetDividerRegister
********************************************************************************
* Summary:
...
{
    return CY_GET_REG16(ADC_1_Ext_CP_Clk_DIV_PTR);
}


/*******************************************************************************
* Function Name: ADC_1_Ext_CP_Clk_SetModeRegister
********************************************************************************
* Summary:
...
*
*******************************************************************************/
void ADC_1_Ext_CP_Clk_SetModeRegister(uint8 clkMode) 
{
    ADC_1_Ext_CP_Clk_MOD_SRC |= clkMode & ADC_1_Ext_CP_Clk_MODE_MASK;
}


/*******************************************************************************
* Function Name: ADC_1_Ext_CP_Clk_ClearModeRegister
********************************************************************************
* Summary:
...
*
*******************************************************************************/
void ADC_1_Ext_CP_Clk_ClearModeRegister(uint8 clkMode) 
{
    ADC_1_Ext_CP_Clk_MOD_SRC &= ~clkMode | ~ADC_1_Ext_CP_Clk_MODE_MASK;
}
...
/*******************************************************************************
* Function Name: ADC_1_Ext_CP_Clk_GetModeRegister
********************************************************************************
* Summary:
...
{
    return ADC_1_Ext_CP_Clk_MOD_SRC & ADC_1_Ext_CP_Clk_MODE_MASK;
}


/*******************************************************************************
* Function Name: ADC_1_Ext_CP_Clk_SetSourceRegister
********************************************************************************
* Summary:
...
{
    uint16 currDiv = ADC_1_Ext_CP_Clk_GetDividerRegister();
    uint8 oldSrc = ADC_1_Ext_CP_Clk_GetSourceRegister();
    ...
    if (oldSrc != CYCLK_SRC_SEL_CLK_SYNC_D && clkSource == CYCLK_SRC_SEL_CLK_SYNC_D && currDiv == 0)
    {
        ...
        ADC_1_Ext_CP_Clk_MOD_SRC |= CYCLK_SSS;
        ADC_1_Ext_CP_Clk_MOD_SRC =
            (ADC_1_Ext_CP_Clk_MOD_SRC & ~ADC_1_Ext_CP_Clk_SRC_SEL_MSK) | clkSource;
    }
...
/*******************************************************************************
* Function Name: ADC_1_Ext_CP_Clk_GetSourceRegister
********************************************************************************
* Summary:
...
{
    return ADC_1_Ext_CP_Clk_MOD_SRC & ADC_1_Ext_CP_Clk_SRC_SEL_MSK;
}
...
/*******************************************************************************
* Function Name: ADC_1_Ext_CP_Clk_SetPhaseRegister
********************************************************************************
* Summary:
...
{
    ADC_1_Ext_CP_Clk_PHASE = clkPhase & ADC_1_Ext_CP_Clk_PHASE_MASK;
}


/*******************************************************************************
* Function Name: ADC_1_Ext_CP_Clk_GetPhase
********************************************************************************
* Summary:
...
{
    return ADC_1_Ext_CP_Clk_PHASE & ADC_1_Ext_CP_Clk_PHASE_MASK;
}
