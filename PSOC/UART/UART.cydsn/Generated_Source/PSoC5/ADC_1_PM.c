...
*
* Global variables:
*  ADC_1_backup:  This global structure variable is used to store 
...
{
    ADC_1_backup.deccr = ADC_1_DEC_CR_REG;
}
...
*
* Global variables:
*  ADC_1_backup:  This global structure variable is used to restore 
...
{
    ADC_1_DEC_CR_REG = ADC_1_backup.deccr;
}
...
*
* Global variables:
*  ADC_1_backup:  The structure field 'enableState' is modified 
...
void ADC_1_Sleep(void) 
{
    ...
    if((ADC_1_ACT_PWR_DEC_EN == (ADC_1_PWRMGR_DEC_REG & ADC_1_ACT_PWR_DEC_EN)) &&
       (ADC_1_ACT_PWR_DSM_EN == (ADC_1_PWRMGR_DSM_REG & ADC_1_ACT_PWR_DSM_EN)))
    {
...
*
* Global variables:
*  ADC_1_backup:  The structure field 'enableState' is used to 
...
void ADC_1_Wakeup(void) 
{
    ...
    if(ADC_1_backup.enableState == ADC_1_ENABLED)
    {
        ADC_1_Enable();

        /* Start the conversion only if conversion is not triggered by the hardware */
        if(!(ADC_1_DEC_CR_REG & ADC_1_DEC_XSTART_EN))
        {
            ADC_1_StartConvert();
        }
